...
| Design language | **TarkovTracker Design System, adapted** (`apps/web/src/design-system/`) — dark-committed tactical console; golden-tan primary on neutral-gunmetal surface ladder, PvP-tan / PvE-blue mode accents, monospace data readouts. Adopting TT's token system (credited) keeps us on the tarkovtracker.org / tarkov.dev bar without rebuilding it, and re-skins only our unique surfaces. | 2026-07-19 |
